HooHacks project
Download the file and run using bash with the python file you are translating as the first argument
for example 
...
Run the ide and then type in python commands: limited
